        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold cursor-pointer' onClick={() => navigate.push("/")}>Support
                        <span className='text-zinc-400'>AI</span></div>
                    <button className='px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition cursor-pointer'
                        onClick={() => navigate.push("/dashboard")}>Back to Dashborad</button>

                </div>
            </div>


            {/* Main script contetnt */}
            ...
            <div className='flex justify-center px-4 py-14'>
                <motion.div
                    ...
                    className="w-full max-w-4xl bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.15)] p-10"
                >
                    <h1 className="text-2xl font-semibold mb-2">Embed Chatbot</h1>
                    <p>Copy and paste this code before <code>&lt;/body&gt;</code></p>
                    <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mmono mb-10">
                        <pre className="overflow-x-auto">{embedCode}</pre>
                        <button className="absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg
                    hover:bg-zinc-200 transition" onClick={copyCode}>
                            {copied ? "copied ✔" : "copy"}
                        </button>
                    </div>
                    ...
                    <ol className="space-t-3 text-sm text-zinc-600 list-decimal list-inside">
                    ...
                    <div className="mt-14">
                        ...
                        <div className="rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden">
                            ...
                            <div className="relative h-64 sm:h-72 p-6 text-zinc-400 text-sm">
                                ...
                                <div className="absolute bottom-16 sm:bottom-24 right-6 w-64 bg-white rounded-xl
                                ...
                                className="absolute bottom-4 sm:bottom-10 right-6 w-14 h-14 rounded-full bg-black text-white
