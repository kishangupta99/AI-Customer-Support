    ...
    return (
        <div className=''>
            ...
            <motion.div
                ...
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div
                        ...
                        className='text-lg font-semibold tracking-tight cursor-pointer'>Support
            ...
            <div className='flex justify-center px-4 py-14 mt-20'>
                ...
                <motion.div
                    className='w-full max-w-3xl bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.15)] p-10'
                >
                    <div className='mb-10'>
                    ...
                    <div className='mb-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            Refund policy: 7-day return available.
